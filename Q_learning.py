...
for episode in range(learning_episodes):
    ...
    for year in range(initial_year, final_year + 1, year_step):
        ...
        selected_actions = (actions[0], actions[1], actions[2])
        action_index = action_to_index[selected_actions]
...
variables = [world3_optimal.le, world3_optimal.fr, world3_optimal.sc, world3_optimal.pop,  world3_optimal.mpld]
labels = ["LE", "FR", "SC", "POP", "MPLD"]
