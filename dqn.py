...
class DQNAgent:
    def __init__(self, state_size, action_size, learning_rate=0.001, gamma=0.95, tau=0.01, epsilon=1.0, epsilon_decay=0.9974, epsilon_min=0.01, memory_size=20000, verbose=0, model_path=None, step_count=0):
